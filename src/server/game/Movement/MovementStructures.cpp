...
//4.3.4
MovementStatusElements MoveUpdateFlightSpeed[] =
{
    MSEPositionY,
    MSESpeedFlight,
    MSEPositionX,
...
//4.3.4
MovementStatusElements MoveUpdateSwimSpeed[] =
{
    MSEHasMovementFlags,
    MSEHasGuidByte2,
    MSEHasSpline,
...
//4.3.4
MovementStatusElements MoveUpdateRunBackSpeed[] =
{
    MSEHasGuidByte1,
    MSEHasGuidByte2,
    MSEHasSplineElevation,
...
//4.3.4
MovementStatusElements MoveUpdateRunSpeed[] =
{
    MSEPositionZ,
    MSEPositionX,
    MSEPositionY,
...
//4.3.4
MovementStatusElements MoveUpdateWalkSpeed[] =
{
    MSEHasPitch,
    MSEHasOrientation,
    MSEZeroBit,
...
//4.3.4
MovementStatusElements MoveForcePitchRateChangeAck[] =
{
    MSEPositionX,
    MSECounter,
    MSESpeedPitchRate,
...
//4.3.4
MovementStatusElements MoveForceTurnRateSpeedChangeAck[] =
{
    MSEPositionX,
    MSEPositionZ,
    MSESpeedTurnRate,
...
//4.3.4
MovementStatusElements MoveForceSwimSpeedChangeAck[] =
{
    MSEPositionX,
    MSECounter,
    MSESpeedSwim,
...
//4.3.4
MovementStatusElements MoveForceWalkSpeedChangeAck[] =
{
    MSEPositionZ,
    MSEPositionY,
    MSESpeedWalk,
...
//4.3.4
MovementStatusElements MoveForceRunBackSpeedChangeAck[] =
{
    MSESpeedRunBack,
    MSECounter,
    MSEPositionX,
...
//4.3.4
MovementStatusElements MoveForceFlightSpeedChangeAck[] =
{
    MSECounter,
    MSEPositionZ,
    MSEPositionX,
...
//4.3.4
MovementStatusElements MoveForceRunSpeedChangeAck[] =
{
    MSECounter,
    MSEPositionX,
    MSESpeedRun,
...
MovementStatusElements MoveGravityDisable[] =
{
    MSEHasGuidByte0,
    MSEHasGuidByte1,
    MSEHasGuidByte5,
...
MovementStatusElements MoveGravityEnable[] =
{
    MSEHasGuidByte1,
    MSEHasGuidByte4,
    MSEHasGuidByte7,
...
// 4.3.4
MovementStatusElements SplineMoveStartSwim[] =
{
    MSEHasGuidByte1,
    MSEHasGuidByte6,
    MSEHasGuidByte0,
...
// 4.3.4
MovementStatusElements SplineMoveStopSwim[] =
{
    MSEHasGuidByte4,
    MSEHasGuidByte1,
    MSEHasGuidByte5,
...
MovementStatusElements SplineMoveLandWalk[] =
{
    MSEHasGuidByte5,
    MSEHasGuidByte0,
    MSEHasGuidByte4,
...
MovementStatusElements SplineMoveWaterWalk[] =
{
    MSEHasGuidByte6,
    MSEHasGuidByte1,
    MSEHasGuidByte4,
...
MovementStatusElements SplineMoveSetFlying[] =
{
    MSEHasGuidByte0,
    MSEHasGuidByte4,
    MSEHasGuidByte1,
...
MovementStatusElements SplineMoveUnsetFlying[] =
{
    MSEHasGuidByte5,
    MSEHasGuidByte0,
    MSEHasGuidByte4,
...
MovementStatusElements SplineMoveSetFeatherFall[] =
{
    MSEHasGuidByte3,
    MSEHasGuidByte2,
    MSEHasGuidByte7,
...
MovementStatusElements SplineMoveSetNormalFall[] =
{
    MSEHasGuidByte3,
    MSEHasGuidByte5,
    MSEHasGuidByte1,
...
MovementStatusElements SplineMoveRoot[] = 
{
    MSEHasGuidByte5,
    MSEHasGuidByte4,
    MSEHasGuidByte6,
...
MovementStatusElements SplineMoveUnRoot[] = 
{
    MSEHasGuidByte0,
    MSEHasGuidByte1,
    MSEHasGuidByte6,
...
MovementStatusElements MoveRoot[] = 
{
    MSEHasGuidByte2,
    MSEHasGuidByte7,
    MSEHasGuidByte6,
...
MovementStatusElements MoveUnRoot[] = 
{
    MSEHasGuidByte0,
    MSEHasGuidByte1,
    MSEHasGuidByte3,
...
Movement::PacketSender::PacketSender(Unit* unit, Opcodes controlled, Opcodes self, MovementInfo* info, bool broadCastSelf, bool broadCastControlled) :
    _unit(unit), _info(info), _BroadCastSelf(broadCastSelf), _BroadCastControlled(broadCastControlled), _isControlledPacket(true)
{
    if (unit->GetTypeId() == TYPEID_PLAYER && unit->ToPlayer())
    {
        if (unit->HasUnitState(UNIT_STATE_CONTROLLED_BY_SERVER)) // controlled by server
            _toSend = controlled;
        else
        {
            _toSend = self;
            _isControlledPacket = false;
        }
    }
    else
    {
        _toSend = controlled;
        _BroadCastControlled = true;
    }
}

void Movement::PacketSender::Send() const
{
    WorldPacket data(_toSend);
            
    _info->WriteToPacket(data);

    if (((!_BroadCastSelf && !_isControlledPacket) || (!_BroadCastControlled && _isControlledPacket)) && _unit->ToPlayer())
        _unit->ToPlayer()->SendDirectMessage(&data);
    else
        _unit->SendMessageToSet(&data, (_unit->GetTypeId() == TYPEID_PLAYER) ? true : false);
}
...
MovementStatusElements* GetMovementStatusElementsSequence(Opcodes opcode)
{
    switch (opcode)
    {
        ...
        case CMSG_MOVE_FORCE_RUN_SPEED_CHANGE_ACK:
            return MoveForceRunSpeedChangeAck;
        case CMSG_MOVE_FORCE_FLIGHT_SPEED_CHANGE_ACK:
            return MoveForceFlightSpeedChangeAck;
        case CMSG_MOVE_FORCE_RUN_BACK_SPEED_CHANGE_ACK:
            return MoveForceRunBackSpeedChangeAck;
        case CMSG_MOVE_FORCE_WALK_SPEED_CHANGE_ACK:
            return MoveForceWalkSpeedChangeAck;
        case CMSG_MOVE_FORCE_SWIM_SPEED_CHANGE_ACK:
            return MoveForceSwimSpeedChangeAck;
        ...
        case CMSG_MOVE_FORCE_TURN_RATE_CHANGE_ACK:
            return MoveForceTurnRateSpeedChangeAck;
        ...
        case SMSG_MOVE_SET_RUN_MODE:
            return MovementSetRunMode;
        case SMSG_MOVE_SET_WALK_MODE:
        ...
        case SMSG_SPLINE_MOVE_SET_LAND_WALK:
            return SplineMoveLandWalk;
        case SMSG_SPLINE_MOVE_SET_WATER_WALK:
            return SplineMoveWaterWalk;
