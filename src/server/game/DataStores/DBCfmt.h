...
char const BattlemasterListEntryfmt[] = "niiiiiiiiixsiiiiiiii";
...
char const CreatureModelDatafmt[] = "nxxxxxxxxxxxxxxffxxxxxxxxxxxxxx";
...
char const GtRegenMPPerSptfmt[] = "df";
...
const std::string CustomSpellEntryfmt = "ppppppppppppppppaaaaaaaaappaapppppppppappppppppa";
...
char const SpellVisualfmt[] = "ixxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxi";
