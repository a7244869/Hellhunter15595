...
int Master::Run()
{
    ...
    #ifdef _WIN32
    {
        ...
        if (Prio)
        {
            if (SetPriorityClass(hProcess, HIGH_PRIORITY_CLASS))
                sLog->outInfo(LOG_FILTER_WORLDSERVER, "hhworldserver class set to HIGH");
            else
                sLog->outError(LOG_FILTER_WORLDSERVER, "Can't set hhworldserver process priority class.");
        }
    }
    #endif
    ...
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "SERVER-STARTING-OK");
